...
public class NetBIOSSMBChannelHandler extends ChannelPacketHandler {
	 ...
	 */
	public NetBIOSSMBChannelHandler(SocketChannel sockChannel, CIFSPacketPool packetPool)
		throws IOException {
		super(sockChannel, SMBSrvPacket.PROTOCOL_NETBIOS, "NetBIOS", "N", packetPool);
	}
