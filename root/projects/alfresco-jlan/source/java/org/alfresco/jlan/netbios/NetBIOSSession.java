...
public final class NetBIOSSession extends NetworkSession {
  ...
  public final static NetBIOSName ConvertAddressToName(String addr, char nbTyp, boolean isGroup, NetBIOSSession sess)
	 ...
	 */
	public static boolean isDebug () { return m_debug; }
  ...
  public final void setSubnetMask(String mask) {
	 ...
	 */
	public static void setDebug ( boolean dbg) { m_debug = dbg; }
	...
	//  nbpkt.setTransactionId( m_tranIdx++);
	  ...
	  nbpkt.setFlags( NetBIOSPacket.FLG_BROADCAST);
	  nbpkt.setQuestionCount( 1);
	  nbpkt.setQuestionName( nodeName, NetBIOSName.WorkStation, NetBIOSPacket.NAME_TYPE_NBSTAT, NetBIOSPacket.NAME_CLASS_IN);
  ...
  /**
	 ...
	 * @param nameType int
	 */
	public void setLocalNameType(char nameType) { m_locNameType = nameType; }
	 ...
	 * @param nameType char
	 */
	public void setRemoteNameType(char nameType) { m_remNameType = nameType; }
