...
public class GalleryViewTest extends AbstractUtils
{
    ...
    public void dataprep_AONE_14014() throws Exception
    {
    ...
    public void AONE_14014() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        ...
        // Creating files.
        ShareUser.createContent(customDrone, content, ContentType.PLAINTEXT);
        ...
        DocumentLibraryPage docLibPage = googleUpdateFile.submit().render();
    ...
    public void dataprep_AONE_14012() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    public void AONE_14012() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14011() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     * Test: This includes AONE_14011 / ALF_8746
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    public void AONE_14011() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14016() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14016() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = { "DataPrepAlfrescoOne", "NonGrid" })
    public void dataprep_AONE_14010() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    public void AONE_14010() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14013() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14013() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14008() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14008() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14007() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14007() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14019() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14019() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14022() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    @Test(groups = "AlfrescoOne")
    public void AONE_14022() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14023() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    public void AONE_14023() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14024() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    @Test(groups = "AlfrescoOne")
    public void AONE_14024() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    public void dataprep_AONE_14021() throws Exception
    {
        ...
        // TODO Move step 3. At least 3 folders (folder1 containing subfolder folder1_1and folder2) and 1 document are created in the Document Library; from
        // test to dataprep
    }

    /**
     * Test: This includes AONE_14021 / ALF_8680
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14009() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    /**
     * Test: This test includes AONE_14009 / ALF_8737
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    public void AONE_14009() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14020() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    /**
     * Test: This test includes AONE_14020 / ALF_8711
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
     ...
     */
    @Test(groups = "DocLibToolBar")
    public void AONE_14020() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    /**
     * Test: AONE-15058:Action "Downloads" for folder
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    /**
     * Test: AONE-14026:Action "Manage Permissions " for folder
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    /**
     * Test: AONE-14027:"Manage Rules" action for folder
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_15057() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    // AONE-15057:Action "Manage Aspects " for folder
    @Test(groups = "EnterpriseOnly")
    public void AONE_15057() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = { "DataPrepAlfrescoOne", "NonGrid" })
    public void dataPrep_AONE_14025() throws Exception
    {
        String testName = getTestName();
        String siteName = getSiteName(testName);
    ...
    /**
     * Test: AONE-14025:Action"View Details" for folder
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14015() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    @Test(groups = { "AlfrescoOne", "IntermittentBugs" })
    public void AONE_14015() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14017() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
    ...
    @Test(groups = "AlfrescoOne")
    public void AONE_14017() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    @Test(groups = "DataPrepAlfrescoOne")
    public void dataprep_AONE_14018() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
     ...
     * Test: This test includes AONE_14018 / ALF_8714
     * <ul>
     * <li>Login</li>
     * <li>Open Site Dashboard</li>
     * <li>Open Document Library in Gallery View</li>
     ...
     */
    @Test(groups = "AlfrescoOne")
    public void AONE_14018() throws Exception
    {
        /** Start Test */
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    public void dataprep_AONE_15055() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
    ...
    // TODO: please check the format String fileTypes too long.
    @Test(groups = { "EnterpriseOnly", "NonGrid" })
    public void AONE_15055() throws Exception
    {
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);

        String[] fileTypes = { "aep", "ai", "aiff", "asf", "asnd", "asx", "au", "avi", "avx", "bmp", "css", "doc", "docm", "docx", "dotm", "eml", "eps", "fla",
                "flac", "flv", "fxp", "gif", "html", "indd", "jpeg", "jpg", "key", "m4v", "mov", "movie", "mp2", "mp3", "mp4", "mpeg2", "mpv2", "numbers",
                "odg", "odp", "ods", "odt", "oga", "ogg", "ogv", "pages", "pdf", "png", "potm", "potx", "ppam", "ppj", "ppsm", "ppsx", "ppt", "pptm", "pptx",
                "psd", "qt", "rtf", "sldm", "sldx", "snd", "spx", "svg", "swf", "tiff", "txt", "wav", "webm", "wma", "wmv", "xbm", "xlam", "xls", "xlsb",
        ...
        for (String fileType : fileTypes)
        {
            ...
            // TODO: cant we use something else or move this code to some utility, it seems waiting is for too long.
