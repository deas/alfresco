...
public class GalleryViewTest extends AbstractTests
{
    ...
    public void alf_8751() throws Exception
    {
        ...
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
        String fileName1 = getFileName(testName) + ShareUser.getRandomStringWithNumders(4) + ".doc";
        String comment = "comment" + ShareUser.getRandomStringWithNumders(4);
    ...
    public void alf_8748() throws Exception
    {
        ...
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
        String fileName1 = getFileName(testName) + ShareUser.getRandomStringWithNumders(4) +".txt";
    ...
    public void alf_8712() throws Exception
    {
        ...
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
        String fileName1 = getFileName(testName + "file1") + ShareUser.getRandomStringWithNumders(4);
        String fileName2 = getFileName(testName + "file2") + ShareUser.getRandomStringWithNumders(4);
    ...
    public void alf_8745() throws Exception
    {
        ...
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
        String fileName1 = getFileName(testName + "1") + ShareUser.getRandomStringWithNumders(4);
    ...
    */
    ...
    public void alf_8728() throws Exception
    {
        ...
        // Verify that document is opened in tab/window.
    ...
    public void alf_8729() throws Exception
    {
        ...
        // File:
        // Edit the name,title,description and save
    ...
    public void alf_8722() throws Exception
    {
        ...
        DocumentLibraryPage docLibPage = ShareUserSitePage.createFolder(customDrone, subFolder, "");
        ...
        docLibPage = ShareUserSitePage.navigateToFolder(customDrone, folder);
    ...
    public void alf_8743() throws Exception
    {
        ...
        String folderName = getFolderName(testName) + System.currentTimeMillis();
        String fileInfo1[] = {fileName1};
        String testFileTagName = "file" + ShareUser.getRandomStringWithNumders(5);
        String testFolderTagName = "folder" + ShareUser.getRandomStringWithNumders(5);
        ...
        docLibPage.getFileDirectoryInfo(fileName1).addTag(testFileTagName);
        docLibPage = docLibPage.getSiteNav().selectSiteDocumentLibrary().render();
        thisRow = docLibPage.getFileDirectoryInfo(fileName1);
        ...
        // Add a tag to the first file
        docLibPage.getFileDirectoryInfo(folderName).addTag(testFolderTagName);
        docLibPage = docLibPage.getSiteNav().selectSiteDocumentLibrary().render();
        thisRow = docLibPage.getFileDirectoryInfo(folderName);
    ...
    public void alf_8721() throws Exception
    {
        ...
        testUser = getUserNameFreeDomain(testName);
        String siteName = getSiteName(testName);
        String fileName1 = getFileName(testName) + ShareUser.getRandomStringWithNumders(4);
        String folderName = getFolderName(testName) + ShareUser.getRandomStringWithNumders(3);
        String fileInfo1[] = {fileName1};
    ...
    public void alf_8679() throws Exception
    {
        ...
        String testName = getTestName();
        testUser = getUserNameFreeDomain(testName);
        String accessUser = getUserNameFreeDomain(testName + "accessUser") + ShareUser.getRandomStringWithNumders(5);
        String siteName = getSiteName(testName);
        String folderName = getFolderName(testName) + ShareUser.getRandomStringWithNumders(3);
        // User
        ...
        // Open document library in Gallery view.
        DocumentLibraryPage docLibPage = ShareUser.openDocumentLibraryInGalleryView(customDrone, siteName);
        FileDirectoryInfo thisRow = docLibPage.getFileDirectoryInfo(folderName);
        
        // click on More and select manage permissions link
        ...
        docLibPage = (DocumentLibraryPage) ShareUserMembers.managePermissionsOnContent(customDrone, accessUser, folderName, UserRole.COLLABORATOR, false);
        thisRow = docLibPage.getFileDirectoryInfo(folderName);
        
        DetailsPage detailsPage = thisRow.selectViewFolderDetails().render();
   ...
   public void alf_8718() throws Exception
   {
       ...
       String siteName = getSiteName(testName);
       String fileName1 = getFileName(testName + "1") + ShareUser.getRandomStringWithNumders(4);
       String folderName = getFolderName(testName + "2") + ShareUser.getRandomStringWithNumders(3);
       String fileInfo1[] = {fileName1};
