...
<!-- Wiki -->
<@link rel="stylesheet" type="text/css" href="${url.context}/res/components/wiki/wiki.css" />
...
<@script type="text/javascript" src="${url.context}/res/components/wiki/parser.js"></@script>
<@script type="text/javascript" src="${url.context}/res/components/wiki/page.js"></@script>
...
<!-- Wiki Versioning -->
<@link rel="stylesheet" type="text/css" href="${url.context}/res/modules/wiki/revert-wiki-version.css" />
<@script type="text/javascript" src="${url.context}/res/modules/wiki/revert-wiki-version.js"></@script>