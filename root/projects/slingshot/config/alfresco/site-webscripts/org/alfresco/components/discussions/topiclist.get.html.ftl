<@markup id="css" >
   <#-- CSS Dependencies -->
   <@link href="${page.url.context}/res/components/discussions/topiclist.css" group="discussions"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script src="${page.url.context}/res/components/discussions/topiclist.js" group="discussions"/>
</@>
