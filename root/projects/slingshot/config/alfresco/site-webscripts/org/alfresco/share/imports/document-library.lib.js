...
createContent.splice(0, 0, {
   ...
   config: {
      label: msg.get("create.folder.label"),
      iconClass: "alf-showfolders-icon",
      publishTopic: "ALF_CREATE_NEW_FOLDER"
   }
});
...
function getDocumentLibraryServices(siteId, containerId, rootNode) {
   return ["alfresco/services/ContentService",
   {
            ...
            },
            {
               ...
               config: 
               {
                  ...
                  [
                     ...
                     {
                        id: "DOCLIB_DND_UPLOAD",
                        name: "alfresco/wrapped/DndUpload"
                     },
                     {
                        id: "DOCLIB_ARCHIVE_AND_DOWNLOAD",
                        name: "alfresco/wrapped/ArchiveAndDownload"
                     }
                  ]
               }
            }
