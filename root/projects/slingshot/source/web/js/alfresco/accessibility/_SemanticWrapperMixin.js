...
define(["dojo/_base/declare",
   ...
   return declare(null, {
       ...
       * 
       * @instance
       * @param {element} outerNode The DOM node in which to create the semantic wrapper
       * @param {element} innerNode The DOM node to move into the created semantic wrapper
       */
