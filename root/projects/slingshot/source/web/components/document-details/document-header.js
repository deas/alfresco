...
(function()
{
    ...
    * @return {Alfresco.component.DocumentHeader} The new DocumentHeader instance
    * @constructor
    */
   Alfresco.component.DocumentHeader = function DocumentHeader_constructor(htmlId)
   {
      Alfresco.component.DocumentHeader.superclass.constructor.call(this, "Alfresco.component.DocumentHeader", htmlId);
      YAHOO.Bubbling.on("metadataRefresh", this.doRefresh, this);
      return this;
   };

   YAHOO.extend(Alfresco.component.DocumentHeader, Alfresco.component.Base,
   {
      /**
       ...
       * @method onReady
       */
      onReady: function DocumentHeader_onReady()
      {
       ...
       * @method doRefresh
       */
      doRefresh: function DocumentHeader_doRefresh()
      {
         YAHOO.Bubbling.unsubscribe("metadataRefresh", this.doRefresh);
         var url = 'components/document-details/document-header?nodeRef={nodeRef}&rootPage={rootPage}';
