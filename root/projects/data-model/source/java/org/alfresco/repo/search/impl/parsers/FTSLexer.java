// $ANTLR 3.3 Nov 30, 2010 12:50:56 W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g 2011-11-03 20:24:40
...
public class FTSLexer extends Lexer {
    ...
    public final void mFLOATING_POINT_LITERAL() throws RecognitionException {
        try {
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1226:9: (start= START_RANGE_I dotdot= DOTDOT end= START_RANGE_I | start= START_RANGE_F dotdot= DOTDOT end= START_RANGE_F | ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )? | ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )? | ( PLUS | MINUS )? ( DIGIT )+ EXPONENT )
            int alt24=5;
            alt24 = dfa24.predict(input);
            switch (alt24) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1227:9: start= START_RANGE_I dotdot= DOTDOT end= START_RANGE_I
                    {
                    int startStart4167 = getCharIndex();
                    int startStartLine4167 = getLine();
                    int startStartCharPos4167 = getCharPositionInLine();
                    mSTART_RANGE_I(); if (state.failed) return ;
                    start = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, startStart4167, getCharIndex()-1);
                    start.setLine(startStartLine4167);
                    start.setCharPositionInLine(startStartCharPos4167);
                    int dotdotStart4171 = getCharIndex();
                    int dotdotStartLine4171 = getLine();
                    int dotdotStartCharPos4171 = getCharPositionInLine();
                    mDOTDOT(); if (state.failed) return ;
                    dotdot = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, dotdotStart4171, getCharIndex()-1);
                    dotdot.setLine(dotdotStartLine4171);
                    dotdot.setCharPositionInLine(dotdotStartCharPos4171);
                    int endStart4175 = getCharIndex();
                    int endStartLine4175 = getLine();
                    int endStartCharPos4175 = getCharPositionInLine();
                    mSTART_RANGE_I(); if (state.failed) return ;
                    end = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, endStart4175, getCharIndex()-1);
                    end.setLine(endStartLine4175);
                    end.setCharPositionInLine(endStartCharPos4175);
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1236:11: start= START_RANGE_F dotdot= DOTDOT end= START_RANGE_F
                    {
                    int startStart4200 = getCharIndex();
                    int startStartLine4200 = getLine();
                    int startStartCharPos4200 = getCharPositionInLine();
                    mSTART_RANGE_F(); if (state.failed) return ;
                    start = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, startStart4200, getCharIndex()-1);
                    start.setLine(startStartLine4200);
                    start.setCharPositionInLine(startStartCharPos4200);
                    int dotdotStart4204 = getCharIndex();
                    int dotdotStartLine4204 = getLine();
                    int dotdotStartCharPos4204 = getCharPositionInLine();
                    mDOTDOT(); if (state.failed) return ;
                    dotdot = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, dotdotStart4204, getCharIndex()-1);
                    dotdot.setLine(dotdotStartLine4204);
                    dotdot.setCharPositionInLine(dotdotStartCharPos4204);
                    int endStart4208 = getCharIndex();
                    int endStartLine4208 = getLine();
                    int endStartCharPos4208 = getCharPositionInLine();
                    mSTART_RANGE_F(); if (state.failed) return ;
                    end = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, endStart4208, getCharIndex()-1);
                    end.setLine(endStartLine4208);
                    end.setCharPositionInLine(endStartCharPos4208);
                    if ( state.backtracking==0 ) {
                    ...
                    break;
                case 3 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1246:9: ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )?
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1246:9: ( PLUS | MINUS )?
                    int alt15=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1250:9: ( DIGIT )+
                    int cnt16=0;
                    loop16:
                    do {
                        int alt16=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1250:20: ( DIGIT )*
                    loop17:
                    do {
                        int alt17=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1250:27: ( EXPONENT )?
                    int alt18=2;
                    ...
                    break;
                case 4 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1252:9: ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )?
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1252:9: ( PLUS | MINUS )?
                    int alt19=2;
                    ...
                    mDOT(); if (state.failed) return ;
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1256:13: ( DIGIT )+
                    int cnt20=0;
                    loop20:
                    do {
                        int alt20=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1256:20: ( EXPONENT )?
                    int alt21=2;
                    ...
                    break;
                case 5 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1258:9: ( PLUS | MINUS )? ( DIGIT )+ EXPONENT
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1258:9: ( PLUS | MINUS )?
                    int alt22=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1262:9: ( DIGIT )+
                    int cnt23=0;
                    loop23:
                    do {
                        int alt23=2;
    ...
    public final void mSTART_RANGE_I() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1284:9: ( ( PLUS | MINUS )? ( DIGIT )+ )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1285:9: ( PLUS | MINUS )? ( DIGIT )+
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1285:9: ( PLUS | MINUS )?
            int alt25=2;
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1289:9: ( DIGIT )+
            int cnt26=0;
            loop26:
            do {
                int alt26=2;
    ...
    public final void mSTART_RANGE_F() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1294:9: ( ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )? | ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )? | ( PLUS | MINUS )? ( DIGIT )+ EXPONENT )
            int alt36=3;
            alt36 = dfa36.predict(input);
            switch (alt36) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1295:9: ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )?
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1295:9: ( PLUS | MINUS )?
                    int alt27=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1299:9: ( DIGIT )+
                    int cnt28=0;
                    loop28:
                    do {
                        int alt28=2;
                    ...
                    mDOT(); if (state.failed) return ;
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1299:20: ( DIGIT )*
                    loop29:
                    do {
                        int alt29=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1299:27: ( EXPONENT )?
                    int alt30=2;
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1301:9: ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )?
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1301:9: ( PLUS | MINUS )?
                    int alt31=2;
                    ...
                    mDOT(); if (state.failed) return ;
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1305:13: ( DIGIT )+
                    int cnt32=0;
                    loop32:
                    do {
                        int alt32=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1305:20: ( EXPONENT )?
                    int alt33=2;
                    ...
                    break;
                case 3 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1307:9: ( PLUS | MINUS )? ( DIGIT )+ EXPONENT
                    {
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1307:9: ( PLUS | MINUS )?
                    int alt34=2;
                    ...
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1311:9: ( DIGIT )+
                    int cnt35=0;
                    loop35:
                    do {
                        int alt35=2;
    ...
    public final void mDECIMAL_NUMERAL() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1319:9: ( ZERO_DIGIT | NON_ZERO_DIGIT ( DIGIT )* )
            int alt38=2;
            ...
            switch (alt38) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1320:9: ZERO_DIGIT
                    {
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1321:11: NON_ZERO_DIGIT ( DIGIT )*
                    {
                    mNON_ZERO_DIGIT(); if (state.failed) return ;
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1321:26: ( DIGIT )*
                    loop37:
                    do {
                        int alt37=2;
    ...
    public final void mDIGIT() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1326:9: ( ZERO_DIGIT | NON_ZERO_DIGIT )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:
            {
    ...
    public final void mZERO_DIGIT() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1333:9: ( '0' )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1334:9: '0'
            {
    ...
    public final void mNON_ZERO_DIGIT() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1339:9: ( '1' .. '9' )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1340:9: '1' .. '9'
            {
    ...
    public final void mE() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1345:9: ( ( 'e' | 'E' ) )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1346:9: ( 'e' | 'E' )
            {
    ...
    public final void mEXPONENT() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1354:9: ( E SIGNED_INTEGER )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1355:9: E SIGNED_INTEGER
            {
    ...
    public final void mSIGNED_INTEGER() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1360:9: ( ( PLUS | MINUS )? ( DIGIT )+ )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1361:9: ( PLUS | MINUS )? ( DIGIT )+
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1361:9: ( PLUS | MINUS )?
            int alt39=2;
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1365:9: ( DIGIT )+
            int cnt40=0;
            loop40:
            do {
                int alt40=2;
    ...
    public final void mFTSWORD() throws RecognitionException {
        try {
            int _type = FTSWORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1390:9: ( ( F_ESC | START_WORD ) ( F_ESC | IN_WORD )* )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1391:9: ( F_ESC | START_WORD ) ( F_ESC | IN_WORD )*
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1391:9: ( F_ESC | START_WORD )
            int alt41=2;
            ...
            switch (alt41) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1392:17: F_ESC
                    {
                    mF_ESC(); if (state.failed) return ;
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1393:19: START_WORD
                    {
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1395:9: ( F_ESC | IN_WORD )*
            loop42:
            do {
                int alt42=3;
                ...
                switch (alt42) {
            	case 1 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1396:17: F_ESC
            	    {
            	    mF_ESC(); if (state.failed) return ;
            	    ...
            	    break;
            	case 2 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1397:19: IN_WORD
            	    {
    ...
    public final void mFTSPRE() throws RecognitionException {
        try {
            int _type = FTSPRE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1402:9: ( ( F_ESC | START_WORD ) ( F_ESC | IN_WORD )* STAR )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1403:9: ( F_ESC | START_WORD ) ( F_ESC | IN_WORD )* STAR
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1403:9: ( F_ESC | START_WORD )
            int alt43=2;
            ...
            switch (alt43) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1404:17: F_ESC
                    {
                    mF_ESC(); if (state.failed) return ;
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1405:19: START_WORD
                    {
                    mSTART_WORD(); if (state.failed) return ;
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1407:9: ( F_ESC | IN_WORD )*
            loop44:
            do {
                int alt44=3;
                ...
                switch (alt44) {
            	case 1 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1408:17: F_ESC
            	    {
            	    mF_ESC(); if (state.failed) return ;
            	    ...
            	    break;
            	case 2 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1409:19: IN_WORD
            	    {
            	    mIN_WORD(); if (state.failed) return ;
    ...
    public final void mFTSWILD() throws RecognitionException {
        try {
            int _type = FTSWILD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1415:9: ( ( F_ESC | START_WORD | STAR | QUESTION_MARK ) ( F_ESC | IN_WORD | STAR | QUESTION_MARK )* )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1416:9: ( F_ESC | START_WORD | STAR | QUESTION_MARK ) ( F_ESC | IN_WORD | STAR | QUESTION_MARK )*
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1416:9: ( F_ESC | START_WORD | STAR | QUESTION_MARK )
            int alt45=4;
            ...
            switch (alt45) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1417:17: F_ESC
                    {
                    mF_ESC(); if (state.failed) return ;
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1418:19: START_WORD
                    {
                    mSTART_WORD(); if (state.failed) return ;
                    ...
                    break;
                case 3 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1419:19: STAR
                    {
                    mSTAR(); if (state.failed) return ;
                    ...
                    break;
                case 4 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1420:19: QUESTION_MARK
                    {
            ...
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1422:9: ( F_ESC | IN_WORD | STAR | QUESTION_MARK )*
            loop46:
            do {
                int alt46=5;
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1424:19: IN_WORD
            	    {
            	    mIN_WORD(); if (state.failed) return ;
            	    ...
            	    break;
            	case 3 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1425:19: STAR
            	    {
            	    mSTAR(); if (state.failed) return ;
            	    ...
            	    break;
            	case 4 :
            	    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1426:19: QUESTION_MARK
            	    {
            	    mQUESTION_MARK(); if (state.failed) return ;
    ...
    public final void mF_ESC() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1432:9: ( '\\\\' ( 'u' F_HEX F_HEX F_HEX F_HEX | . ) )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1433:9: '\\\\' ( 'u' F_HEX F_HEX F_HEX F_HEX | . )
            {
            match('\\'); if (state.failed) return ;
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1434:9: ( 'u' F_HEX F_HEX F_HEX F_HEX | . )
            int alt47=2;
            ...
            switch (alt47) {
                case 1 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1436:17: 'u' F_HEX F_HEX F_HEX F_HEX
                    {
                    ...
                    break;
                case 2 :
                    // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1438:19: .
                    {
    ...
    public final void mF_HEX() throws RecognitionException {
        try {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:1444:9: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:2282:9: ( ( ' ' | '\\t' | '\\r' | '\\n' | '\\u000C' | '\\u00a0' | '\\u1680' | '\\u180e' | '\\u2000' .. '\\u200b' | '\\u2028' .. '\\u2029' | '\\u202f' | '\\u205f' | '\\u3000' )+ )
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:2283:9: ( ' ' | '\\t' | '\\r' | '\\n' | '\\u000C' | '\\u00a0' | '\\u1680' | '\\u180e' | '\\u2000' .. '\\u200b' | '\\u2028' .. '\\u2029' | '\\u202f' | '\\u205f' | '\\u3000' )+
            {
            // W:\\alfresco\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\FTS.g:2283:9: ( ' ' | '\\t' | '\\r' | '\\n' | '\\u000C' | '\\u00a0' | '\\u1680' | '\\u180e' | '\\u2000' .. '\\u200b' | '\\u2028' .. '\\u2029' | '\\u202f' | '\\u205f' | '\\u3000' )+
            int cnt48=0;
            loop48:
    ...
    class DFA24 extends DFA {
        ...
        public String getDescription() {
            return "1224:1: FLOATING_POINT_LITERAL : (start= START_RANGE_I dotdot= DOTDOT end= START_RANGE_I | start= START_RANGE_F dotdot= DOTDOT end= START_RANGE_F | ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )? | ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )? | ( PLUS | MINUS )? ( DIGIT )+ EXPONENT );";
        }
    }
    ...
    class DFA36 extends DFA {
        ...
        public String getDescription() {
            return "1292:1: fragment START_RANGE_F : ( ( PLUS | MINUS )? ( DIGIT )+ DOT ( DIGIT )* ( EXPONENT )? | ( PLUS | MINUS )? DOT ( DIGIT )+ ( EXPONENT )? | ( PLUS | MINUS )? ( DIGIT )+ EXPONENT );";
        }
    }
