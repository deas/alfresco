// $ANTLR 3.3 Nov 30, 2010 12:50:56 C:\\workspaces\\HEAD\\HEAD\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g 2011-08-12 12:03:22
...
public class CMISParser extends Parser {
        ...
        try {
            ...
            switch (alt12) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: RPAREN, functionArgument, cmisFunctionName, LPAREN
                    // token labels: 
    ...
    public final CMISParser.quantifiedInPredicate_return quantifiedInPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ANY, columnReference, inValueList, NOT
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
