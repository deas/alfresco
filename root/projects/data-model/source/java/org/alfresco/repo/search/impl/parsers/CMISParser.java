// $ANTLR 3.3 Nov 30, 2010 12:50:56 W:\\alfresco\\V4.1-BUG-FIX\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g 2012-08-20 13:21:42
...
public class CMISParser extends Parser {
    ...
    // $ANTLR start "query"
    // W:\\alfresco\\V4.1-BUG-FIX\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g:279:1: query : SELECT selectList fromClause ( whereClause )? ( orderByClause )? EOF -> ^( QUERY selectList fromClause ( whereClause )? ( orderByClause )? ) ;
        ...
        try {
            ...
            switch (alt12) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: RPAREN, LPAREN, functionArgument, functionName
                    // token labels: 
    ...
    public final CMISParser.joinedTable_return joinedTable() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: tableReference, JOIN, joinType, joinSpecification
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    // W:\\alfresco\\V4.1-BUG-FIX\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g:532:1: searchOrCondition : searchAndCondition ( OR searchAndCondition )* -> ^( DISJUNCTION ( searchAndCondition )+ ) ;
    ...
    // W:\\alfresco\\V4.1-BUG-FIX\\root\\projects\\data-model\\source\\java\\org\\alfresco\\repo\\search\\impl\\parsers\\CMIS.g:542:1: searchAndCondition : searchNotCondition ( AND searchNotCondition )* -> ^( CONJUNCTION ( searchNotCondition )+ ) ;
    ...
    public final CMISParser.quantifiedInPredicate_return quantifiedInPredicate() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: columnReference, inValueList, NOT, ANY
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
