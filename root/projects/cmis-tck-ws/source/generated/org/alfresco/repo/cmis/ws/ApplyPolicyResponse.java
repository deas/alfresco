...
public class ApplyPolicyResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the extension value for this ApplyPolicyResponse.
     * 
    ...
    /**
     * Sets the extension value for this ApplyPolicyResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ApplyPolicyResponse)) return false;
        ApplyPolicyResponse other = (ApplyPolicyResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ApplyPolicyResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/messaging/200908/", ">applyPolicyResponse"));
