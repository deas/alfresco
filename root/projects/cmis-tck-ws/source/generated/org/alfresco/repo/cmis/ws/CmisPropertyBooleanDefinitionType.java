/**
 * CmisPropertyBooleanDefinitionType.java
 *
...
public class CmisPropertyBooleanDefinitionType  extends org.alfresco.repo.cmis.ws.CmisPropertyDefinitionType  implements java.io.Serializable {
    private org.alfresco.repo.cmis.ws.CmisPropertyBoolean defaultValue;
    ...
    public CmisPropertyBooleanDefinitionType(
           ...
           org.alfresco.repo.cmis.ws.CmisPropertyBoolean defaultValue,
    ...
    /**
     * Gets the defaultValue value for this CmisPropertyBooleanDefinitionType.
     * 
     * @return defaultValue
     */
    public org.alfresco.repo.cmis.ws.CmisPropertyBoolean getDefaultValue() {
        return defaultValue;
    }


    /**
     * Sets the defaultValue value for this CmisPropertyBooleanDefinitionType.
     * 
     * @param defaultValue
     */
    public void setDefaultValue(org.alfresco.repo.cmis.ws.CmisPropertyBoolean defaultValue) {
        this.defaultValue = defaultValue;
    }


    /**
     * Gets the choice value for this CmisPropertyBooleanDefinitionType.
     * 
     * @return choice
     */
    ...
    /**
     * Sets the choice value for this CmisPropertyBooleanDefinitionType.
     * 
     * @param choice
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CmisPropertyBooleanDefinitionType)) return false;
        CmisPropertyBooleanDefinitionType other = (CmisPropertyBooleanDefinitionType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CmisPropertyBooleanDefinitionType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://docs.oasis-open.org/ns/cmis/core/200908/", "cmisPropertyBooleanDefinitionType"));
