...
public class RepositoryServiceLocator extends org.apache.axis.client.Service implements org.alfresco.repo.cmis.ws.RepositoryService {
    ...
    private java.lang.String RepositoryServicePort_address = "http://cmis/services/RepositoryService.RepositoryServicePort";
    ...
    public org.alfresco.repo.cmis.ws.RepositoryServicePort getRepositoryServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public org.alfresco.repo.cmis.ws.RepositoryServicePort getRepositoryServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.alfresco.repo.cmis.ws.RepositoryServicePortBindingStub _stub = new org.alfresco.repo.cmis.ws.RepositoryServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.alfresco.repo.cmis.ws.RepositoryServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                org.alfresco.repo.cmis.ws.RepositoryServicePortBindingStub _stub = new org.alfresco.repo.cmis.ws.RepositoryServicePortBindingStub(new java.net.URL(RepositoryServicePort_address), this);
                _stub.setPortName(getRepositoryServicePortWSDDServiceName());
                return _stub;
            }
        }
