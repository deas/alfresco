 ...
 * 
 * Version 1.1 - Last updated: 2009.04.19
 * 
 */

Mobile.thirdparty.SpinningWheel = {
	cellHeight: 44,
	friction: 0.003,
	slotData: [],
	...
	handleEvent: function (e) {
		if (e.type == 'touchstart') {
			...
			if (e.currentTarget.id == 'sw-cancel' || e.currentTarget.id == 'sw-done' || e.currentTarget.id == 'sw-clear') {
				this.tapDown(e);
	...
	create: function () {
		...
		div.innerHTML = '<div id="sw-header"><div id="sw-cancel">Cancel</' + 'div><div id="sw-clear">Clear</' + 'div><div id="sw-done">Done</' + 'div></' + 'div><div id="sw-slots-wrapper"><div id="sw-slots"></' + 'div></' + 'div><div id="sw-frame"></' + 'div>';
		...
		document.getElementById('sw-clear').addEventListener('touchstart', this, false);		
	...
	open: function () {
		...
		this.swWrapper.style.webkitTransform = 'translate(0, -260px)';
	},
	...
	destroy: function () {
		...
		document.getElementById('sw-clear').removeEventListener('touchstart', this, false);		
	...
	close: function () {
		...
		this.swWrapper.style.webkitTransitionDuration = '400ms';
		this.swWrapper.style.webkitTransform = 'translate(0, 0)';
	...
	setPosition: function (slot, pos) {
		...
		this.slotEl[slot].style.webkitTransform = 'translate(0, ' + pos + 'px)';
	},
	...
	scrollStart: function (e) {
		...
		var theTransform = parseInt(window.getComputedStyle(this.slotEl[this.activeSlot], null).webkitTransform.split(',')[13], 10);
	...
	tapUp: function (e) {
		...
		else if (e.currentTarget.id == 'sw-clear') {
		   this.clearAction();
		} else {
			this.doneAction();
		}
	...
	setClearAction: function(action) {
