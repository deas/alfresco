/* This is a patched version of tinymce which fixes issues when tinymce is
   dynamically loaded. See PATCH comments
*/
...
var tinymce = {
   ...
   _init : function() {
      ...
      for (i=0; i<nl.length; i++) {
       ...
       /* PATCH added _min_patched and _src_patched to regex */
      function getBase(n) {
         if (n.src && /tiny_mce(|_dev|_src|_gzip|_jquery|_prototype|_min_patched|_src_patched).js/.test(n.src)) {
...
(function() {
   ...
   /* PATCH Event._wait() removed and Event._pageInit) added. Fixes FF and IE
    * loading errors.
    */
   Event._pageInit();
