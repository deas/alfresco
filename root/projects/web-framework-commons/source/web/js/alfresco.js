...
/**
 * Convert an ISO8601 datetime/date string into a JavaScript native Date object.
 * 
 * Note 1. This method ignores the time info. In other words it will set the hour, minute, seconds and milliseconds to 0.
 * 
 * Note 2. This method will not take the client's TimeZone (TZ) into account. E.g. if the client's TZ is UTC-02:00,
 * giving "2013-12-02T00:00:00.000Z" as an argument, it will NOT convert the datetime to "2013-12-01T22:00:00.000-02:00".
 * It simply extracts the date from the given argument without applying any TZ.
 * 
 * @method Alfresco.util.dateWithoutTZFromISO8601
 * @param date {string} ISO8601 formatted date string
 * @return {Date|null} JavaScript native Date object
 * @static
 */
Alfresco.util.dateWithoutTZFromISO8601 = function(date)
{
   //   summary:
   ...
   //      Improperly formatted input may return null.  Arguments which are out of bounds will be handled
   ...
   try
   {
      ...
      if (match)
      {
         ...
         result = new Date(match[0]||1970, match[1]||0, match[2]||1, 0, 0, 0, 0);
      }
