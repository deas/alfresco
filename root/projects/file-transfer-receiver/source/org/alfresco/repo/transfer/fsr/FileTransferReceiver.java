...
public class FileTransferReceiver implements TransferReceiver
{
    ...
    public void end(final String transferId)
    {
        ...
        try
        {
            ...
            /*
             * //Fire the OnEndInboundTransfer policy Set<NodeRef> createdNodes = Collections.emptySet(); Set<NodeRef>
             * updatedNodes = Collections.emptySet(); Set<NodeRef> deletedNodes = Collections.emptySet();
             * TransferChangesRecord changesRecord = progressMonitor.removeChangeRecord(transferId); if (changesRecord !=
             * null) { createdNodes = new HashSet<NodeRef>(changesRecord.getCreatedNodes()); updatedNodes = new HashSet<NodeRef>(changesRecord.getUpdatedNodes());
    ...
    {
        return new TransferVersionImpl("3", "4", "2", "Enterprise");
    }
            ...
            throws TransferException
    {
        ...
        try
        {
            ...
            contents.put(transferId, stagedFile);
        }
        catch (Exception ex)
        {
