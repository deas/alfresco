...
*  File     AVMWebappClassLoader.java
*
*
*  NOTICE
*  ------
...
*                share/org/apache/catalina/loader/WebappClassLoader.java
*
 ...
 * @version $Revision: 378251 $ $Date: 2006-02-16 09:19:13 -0500 (Thu, 16 Feb 2006) $
 */
public class AVMWebappClassLoader
    extends URLClassLoader
    implements Reloader, Lifecycle
 {

    protected static org.apache.commons.logging.Log log=
        org.apache.commons.logging.LogFactory.getLog( AVMWebappClassLoader.class );
     ...
     * parent ClassLoader.
     */
    public AVMWebappClassLoader(ClassLoader parent) {
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("AVMWebappClassLoader\r\n");
        sb.append("  delegate: ");
        sb.append(delegate);
        sb.append("\r\n");
    ...
    public Enumeration<java.net.URL> findResources(String name) throws IOException {
        ...
        if (hasExternalRepositories) {
            ...
            Enumeration<java.net.URL> otherResourcePaths = super.findResources(name);
     ...
     * of AVMWebappClassLoader is for a web application context,
                        ...
                        if (!loadedByThisOrChild(valueClass)) {
                            if (log.isDebugEnabled()) {
                                log.debug("Not setting field " + field.getName() +
                                        ...
                                        valueClass.getName() + 
                                        " which was not loaded by this AVMWebappClassLoader.");
                            }
                        } else {
