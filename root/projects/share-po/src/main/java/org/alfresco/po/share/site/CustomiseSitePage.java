...
public class CustomiseSitePage extends SitePage
{
    ...
    public CustomiseSitePage(WebDrone drone)
    {
        super(drone);
    }
    ...
    @Override
    public CustomiseSitePage render(RenderTime timer)
    {
        elementRender(timer, 
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CustomiseSitePage render(long time)
    {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public CustomiseSitePage render()
    {
