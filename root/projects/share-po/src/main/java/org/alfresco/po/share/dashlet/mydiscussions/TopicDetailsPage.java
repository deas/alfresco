...
public class TopicDetailsPage extends SitePage
{
    ...
    public String getTopicTitle()
    {
        ...
        {
            logger.error("Unable find topic title on Topic Details Page." + nse.getMessage());
    ...
    public String getTopicCreationDate()
    {
        ...
        {
            logger.error("Unable find topic creation date on Topic Details Page." + nse.getMessage());
    ...
    public String getTopicCreatedBy()
    {
        ...
        {
            logger.error("Unable find topic created by text on Topic Details Page." + nse.getMessage());
    ...
    public String getTopicAuthor()
    {
        ...
        {
            logger.error("Unable find topic author on Topic Details Page." + nse.getMessage());
    ...
    public String getTopicText()
    {
        ...
        {
            logger.error("Unable find topic text on Topic Details Page." + nse.getMessage());
    ...
    public String getTopicReplies()
    {
        ...
        {
            logger.error("Unable find topic replies on Topic Details Page." + nse.getMessage());
    ...
    public HtmlPage clickOnTopicTitle()
    {
        ...
        catch (TimeoutException te)
        {
            ...
            {
                logger.debug("Exceeded the time to find css title on Topic Details Page." + te.getMessage());
            }
        }
        throw new PageOperationException("Cannot find topic title on Topic Details Page.");
    }
    ...
    public HtmlPage clickOnTopicAuthor()
    {
        ...
        catch (NoSuchElementException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.debug("Exceeded the time to find css author on Topic Details Page." + te.getMessage());
            }
        }
        throw new PageOperationException("Cannot find topic author on Topic Details Page.");
    }
    ...
    public HtmlPage clickOnTopicTagsLink()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.debug("Exceeded the time to find css for topic tags link on Topic Details Page." + te.getMessage());
            }
        }
    ...
    public TopicDetailsPage clickOnReplyLink()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.error("Exceeded the time to find css for topic reply link on Topic Details Page." + te.getMessage());
            }
        }
    ...
    public HtmlPage clickOnEditLink()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.error("Exceeded the time to find css for topic edit link on Topic Details Page." + te.getMessage());
            }
        }
    ...
    public DeleteTopicDialogPage clickOnDeleteLink()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.error("Exceeded the time to find css for topic delete link on Topic Details Page." + te.getMessage());
            }
        }
    ...
    public HtmlPage clickOnNewTopicLink()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.error("Exceeded the time to find css for new topic link on Topic Details Page." + te.getMessage());
            }
        }
