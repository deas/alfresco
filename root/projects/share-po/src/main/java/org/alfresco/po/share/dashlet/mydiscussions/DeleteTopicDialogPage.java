...
public class DeleteTopicDialogPage extends SharePage
{
    ...
    public TopicsListPage clickOnDeleteButton()
    {
        ...
        catch (TimeoutException te)
        {
            ...
            {
                logger.error("Exceeded the time to find xpath for topic delete button on Delete Topic Page." + te.getMessage());
            }
        }
    ...
    public void clickOnCancelButton()
    {
        ...
        catch (TimeoutException te)
        {
            if (logger.isDebugEnabled())
            {
                logger.error("Exceeded the time to find xpath for cancel topic delete button on Delete Topic Page." + te.getMessage());
            }
        }
