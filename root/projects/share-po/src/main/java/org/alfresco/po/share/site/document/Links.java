...
public enum Links
{
    ...
    public enum DetailsPageType{COMMON, DOCUMENT, FOLDER};
        
    private String linkValue;
    private DetailsPageType typeValue;
    
    private Links(String link, DetailsPageType type)
    {        
        linkValue = link;
        typeValue = type;
    }
     ...
     * @return
     */
    public String getLink(DetailsPageType type) {
        if(this.typeValue.equals(DetailsPageType.COMMON) || type.equals(typeValue))
        {
            return linkValue;
        }
