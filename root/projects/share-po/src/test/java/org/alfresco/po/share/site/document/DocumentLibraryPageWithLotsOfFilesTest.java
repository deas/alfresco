...
//        newFolderPage.createNewFolder("michaels-test").render();
//
//        newFolderPage = documentLibPage.getNavigation().selectCreateNewFolder();
//        newFolderPage.createNewFolder("mikes-test").render();
//
//        newFolderPage = documentLibPage.getNavigation().selectCreateNewFolder();
//        newFolderPage.createNewFolder("last-test").render();
//    }
//    
//    /**
...
//    {
//        RenderTime timer = new RenderTime(3000);
//        while(true)
//        {
//        	timer.start();
//            synchronized (this)
