...
public class DocumentLibraryPageTest extends AbstractDocumentTest
{
        ...
        public void isContentUploadedSucessfulTest() throws Exception
        {
                ...
                UploadFilePage uploadForm = documentLibPage.getNavigation().selectFileUpload().render();
                documentLibPage = uploadForm.uploadFile(file1.getCanonicalPath()).render();
                assertTrue(documentLibPage.isContentUploadedSucessful(file1.getName()), "File is uploaded successfully");
        }
        ...
        public void testZoom()
        {
                ...
                double actualFileHeight = documentLibPage.getFileDirectoryInfo(tempFile.getName()).getFileOrFolderHeight();
                ...
                fileHeightSize = documentLibPage.getFileDirectoryInfo(tempFile.getName()).getFileOrFolderHeight();
                assertTrue(fileHeightSize > actualFileHeight);
                ...
                actualFileHeight = documentLibPage.getFileDirectoryInfo(tempFile.getName()).getFileOrFolderHeight();
                assertTrue(fileHeightSize < actualFileHeight);
