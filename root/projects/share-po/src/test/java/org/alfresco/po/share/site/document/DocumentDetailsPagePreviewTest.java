...
public class DocumentDetailsPagePreviewTest extends AbstractDocumentTest
{
    ...
    /**
     * Test that a Word document is correctly displayed using the PdfJs previewer
     * 
     * @throws IOException
     */
    @Test
    public void testWord2003Preview() throws Exception
    {
        File file2 = SiteUtil.prepareFile("File-1"+System.currentTimeMillis(), "This is a sample file", ".doc");
        DocumentLibraryPage documentLibPage = site.getSiteNav().selectSiteDocumentLibrary().render();
        UploadFilePage uploadForm = documentLibPage.getNavigation().selectFileUpload().render();
        documentLibPage = uploadForm.uploadFile(file2.getCanonicalPath()).render();
        documentLibPage.render();
        DocumentDetailsPage docDetailsPage = selectDocument(file2).render();
     ...
     */
    @Test
    public void testWord2007Preview() throws Exception
    {
        File file3 = SiteUtil.prepareFile("File-1"+System.currentTimeMillis(), "This is a sample file", ".docx");
        DocumentLibraryPage documentLibPage = site.getSiteNav().selectSiteDocumentLibrary().render();
        UploadFilePage uploadForm = documentLibPage.getNavigation().selectFileUpload().render();
        documentLibPage = uploadForm.uploadFile(file3.getCanonicalPath()).render();
        documentLibPage.render();
        DocumentDetailsPage docDetailsPage = selectDocument(file3).render();
     ...
     */
    @Test
    public void testTextPreview() throws Exception
    {
        File file4 = SiteUtil.prepareFile("File-1"+System.currentTimeMillis(), "This is a sample file", ".txt");
        DocumentLibraryPage documentLibPage = site.getSiteNav().selectSiteDocumentLibrary().render();
        UploadFilePage uploadForm = documentLibPage.getNavigation().selectFileUpload().render();
        documentLibPage = uploadForm.uploadFile(file4.getCanonicalPath()).render();
        documentLibPage.render();
        DocumentDetailsPage docDetailsPage = selectDocument(file4).render();
