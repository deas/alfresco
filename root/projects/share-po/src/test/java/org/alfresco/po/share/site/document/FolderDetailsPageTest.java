...
//        Map<String, String> properties = folderDetailsPage.getProperties();       
...
//    }
//    @Test(dependsOnMethods = "testFolderComments", groups = {"Enterprise4.2"})
//    public void testDownloadAsZipFolder()
//    {
//        if (logger.isTraceEnabled()) logger.trace("====testDownloadAsZipFolder====");
