    ...
    <form action="" method="post">
        <fieldset class="blog-comment-fieldset">
            ...
            <ul>
                ...
                <li>
                    <input type="text" name="visitorEmail" class="bc-input" value="${visitorEmail!''}" maxlength="200"/>                      
                ...
                <li>
                    <input type="text" name="feedbackSubject" class="bc-input" value="${feedbackSubject!''}" maxlength="200"/>                      
