...
public class EnableDisableAuditByTypesCapability extends AbstractCapability
{

    public EnableDisableAuditByTypesCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.ENABLE_DISABLE_AUDIT_BY_TYPES;
    }
}