        ...
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            public Object execute() throws Throwable
            {
                ...
                filePlan = nodeService.createNode(
                        ...
                        DOD5015Model.TYPE_FILE_PLAN, 
                        DOD5015Model.TYPE_FILE_PLAN).getChildRef();
    ...
    private NodeRef createRecordSeries(final NodeRef filePlan, final String name, final String identifier, final String title, final String description)
    {
        return retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<NodeRef>()
        {
            ...
            public NodeRef execute() throws Throwable
            {
                ...
                NodeRef recordSeried = nodeService.createNode(filePlan, ContentModel.ASSOC_CONTAINS, DOD5015Model.TYPE_RECORD_SERIES, DOD5015Model.TYPE_RECORD_SERIES, properties).getChildRef();
    ...
    protected void checkCapability(final String user, final NodeRef nodeRef, final String capabilityName, final AccessStatus expected)
    {
        AuthenticationUtil.runAs(new RunAsWork<Object>()
        {
            ...
            public Object doWork() throws Exception
            {
                ...
                Map<Capability, AccessStatus> access = rmEntryVoter.getCapabilities(nodeRef, capabilities);
