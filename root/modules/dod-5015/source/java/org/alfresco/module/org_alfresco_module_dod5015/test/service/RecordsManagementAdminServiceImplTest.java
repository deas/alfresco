                                                              ...
                                                              OnCreateReference
{
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_dod5015.test.util.BaseRMTestCase#setUp()
     */
    @Override
    ...
    /**
     * @see org.alfresco.module.org_alfresco_module_dod5015.test.util.BaseRMTestCase#tearDown()
     */
    @Override
...
//        }); 
    ...
    public void testCreateAndUseCustomProperty() throws Exception
    {
        ...
        final NodeRef testRecord = retryingTransactionHelper.doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<NodeRef>()
        {
            public NodeRef execute() throws Throwable
            {
                NodeRef result = createRecord(rmFolder, "testRecord" + System.currentTimeMillis());
                return result;
            }
        });
        ...
        final QName generatedQName = retryingTransactionHelper.doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<QName>()
        {
            ...
            {
                QName result = adminService.addCustomPropertyDefinition(
                		null,
                        TYPE_RECORD_FOLDER,
                        "foo", 
        ...
        retryingTransactionHelper.doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Void>()
        {
            ...
            {
                // Confirm the custom property is included in the list from adminService.
                Map<QName, PropertyDefinition> customPropDefinitions = adminService.getCustomPropertyDefinitions(TYPE_RECORD_FOLDER);
                PropertyDefinition propDefn = customPropDefinitions.get(generatedQName);
                assertNotNull("Custom property definition from adminService was null.", propDefn);
            ...
            retryingTransactionHelper.doInTransaction(new RetryingTransactionHelper.RetryingTransactionCallback<Void>()
                {
                    public Void execute() throws Throwable
                    {
                        ...
                        adminService.removeCustomPropertyDefinition(generatedQName);
                        return null;
                    } 
                });
