...
public class DeclareRecordsInClosedFoldersCapability extends AbstractCapability
{

    public DeclareRecordsInClosedFoldersCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.DECLARE_RECORDS_IN_CLOSED_FOLDERS;
    }
}