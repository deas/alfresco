 ...
 */
package org.alfresco.module.org_alfresco_module_dod5015.test.capabilities;
 ...
 */
public class CapabilitiesTest extends BaseTestCapabilities
{
    /**
    ...
    public void testPermissionsModel()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            public Object execute() throws Throwable
            {
                ...
                Set<PermissionReference> exposed = permissionModel.getExposedPermissions(ASPECT_FILE_PLAN_COMPONENT);
                assertEquals(6, exposed.size());
                assertTrue(exposed.contains(permissionModel.getPermissionReference(ASPECT_FILE_PLAN_COMPONENT, ROLE_ADMINISTRATOR)));
        
                // Check all the permission are there
                Set<PermissionReference> all = permissionModel.getAllPermissions(ASPECT_FILE_PLAN_COMPONENT);
                assertEquals(58 /* capbilities */* 2 + 5 /* roles */+ (2 /* Read+File */* 2) + 1 /* Filing */, all.size());
        
                /*
                 * Check the granting for each permission.
                 * It is assumed that the ROLE_ADMINISTRATOR always has grant permission so is automatically checked.
                 */        
                checkGranting(
                        ACCESS_AUDIT, 
                ...
                checkGranting(
                        ATTACH_RULES_TO_METADATA_PROPERTIES,          
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        AUTHORIZE_ALL_TRANSFERS,                      
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        AUTHORIZE_NOMINATED_TRANSFERS, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        CHANGE_OR_DELETE_REFERENCES, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        CLOSE_FOLDERS, 
                            ROLE_RECORDS_MANAGER, 
                ...
                checkGranting(
                        EDIT_RECORD_METADATA, 
                            ...
                            ROLE_POWER_USER);
                checkGranting(
                        EDIT_SELECTION_LISTS, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        ENABLE_DISABLE_AUDIT_BY_TYPES, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        EXPORT_AUDIT, 
                            ROLE_RECORDS_MANAGER);
                ...
                checkGranting(
                        UNFREEZE, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
                        UPDATE_CLASSIFICATION_DATES, 
                            ROLE_RECORDS_MANAGER,
                            ROLE_SECURITY_OFFICER);
                checkGranting(
                        UPDATE_EXEMPTION_CATEGORIES, 
                            ROLE_RECORDS_MANAGER,
                            ROLE_SECURITY_OFFICER);
                checkGranting(
                        UPDATE_TRIGGER_DATES, 
                            ROLE_RECORDS_MANAGER);
                checkGranting(
     ...
     * @param roles         grant roles
     */
    private void checkGranting(String permission, String... roles)
    {        
        Set<PermissionReference> granting = permissionModel.getGrantingPermissions(
                permissionModel.getPermissionReference(RecordsManagementModel.ASPECT_FILE_PLAN_COMPONENT,
                permission));
        ...
        assertTrue(test.contains(permissionModel.getPermissionReference(RecordsManagementModel.ASPECT_FILE_PLAN_COMPONENT, ROLE_ADMINISTRATOR)));
    ...
    public void testConfig()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            public Object execute() throws Throwable
            {
                ...
                testCapabilityActions(2, APPROVE_RECORDS_SCHEDULED_FOR_CUTOFF);
                testCapabilityActions(0, ATTACH_RULES_TO_METADATA_PROPERTIES);
                ...
                testCapabilityActions(0, CREATE_AND_ASSOCIATE_SELECTION_LISTS);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_CLASSIFICATION_GUIDES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_EVENTS);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_FILEPLAN_METADATA);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_FILEPLAN_TYPES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_FOLDERS);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_RECORD_TYPES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_REFERENCE_TYPES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_ROLES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_TIMEFRAMES);
                testCapabilityActions(0, CREATE_MODIFY_DESTROY_USERS_AND_GROUPS);
                testCapabilityActions(0, CREATE_MODIFY_RECORDS_IN_CUTOFF_FOLDERS);
                ...
                testCapabilityActions(1, DECLARE_RECORDS_IN_CLOSED_FOLDERS);
                ...
                testCapabilityActions(1, DESTROY_RECORDS_SCHEDULED_FOR_DESTRUCTION);
                ...
                testCapabilityActions(1, EXTEND_RETENTION_PERIOD_OR_FREEZE);
                testCapabilityActions(1, FILE_RECORDS);
                testCapabilityActions(0, MAKE_OPTIONAL_PARAMETERS_MANDATORY);
                testCapabilityActions(0, MANAGE_ACCESS_CONTROLS);
                testCapabilityActions(0, MANAGE_ACCESS_RIGHTS);
                testCapabilityActions(1, MANUALLY_CHANGE_DISPOSITION_DATES);
                testCapabilityActions(0, MAP_CLASSIFICATION_GUIDE_METADATA);
                ...
                testCapabilityActions(0, UPDATE_VITAL_RECORD_CYCLE_INFORMATION);
                testCapabilityActions(0, UPGRADE_DOWNGRADE_AND_DECLASSIFY_RECORDS);
    ...
    {
        assertEquals(count, recordsManagementSecurityService.getCapability(capability).getActionNames().size());
    }
    ...
    public void testFilePlanAsSystem()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            public Object execute() throws Throwable
            {
                ...
                check(access, CREATE_MODIFY_DESTROY_FILEPLAN_METADATA, AccessStatus.ALLOWED);
    ...
    /**
     * Test record series as administrator
     */
    ...
    /**
     * Test record series as record manager
     */
    public void testRecordSeriesAsRecordsManager()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            {
                AuthenticationUtil.setFullyAuthenticatedUser(rm_records_manager);
                permissionService.setPermission(recordSeries, rm_records_manager, FILING, true);
                Map<Capability, AccessStatus> access = recordsManagementSecurityService.getCapabilities(recordSeries);
                assertEquals(65, access.size()); // 58 + File
                check(access, ACCESS_AUDIT, AccessStatus.ALLOWED);
                check(access, ADD_MODIFY_EVENT_DATES, AccessStatus.DENIED);
    ...
    /**
     * Test record series as security officer
     */
    public void testRecordSeriesAsSecurityOfficer()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            {
                AuthenticationUtil.setFullyAuthenticatedUser(rm_security_officer);
                permissionService.setPermission(recordSeries, rm_security_officer, FILING, true);
                Map<Capability, AccessStatus> access = recordsManagementSecurityService.getCapabilities(recordSeries);
                assertEquals(65, access.size()); // 58 + File
                check(access, ACCESS_AUDIT, AccessStatus.DENIED);
                check(access, ADD_MODIFY_EVENT_DATES, AccessStatus.DENIED);
    ...
    /**
     * Test record series as power user
     */
    public void testRecordSeriesAsPowerUser()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            {
                AuthenticationUtil.setFullyAuthenticatedUser(rm_power_user);
                permissionService.setPermission(recordSeries, rm_power_user, FILING, true);
                Map<Capability, AccessStatus> access = recordsManagementSecurityService.getCapabilities(recordSeries);
                assertEquals(65, access.size()); // 58 + File
                check(access, ACCESS_AUDIT, AccessStatus.DENIED);
                check(access, ADD_MODIFY_EVENT_DATES, AccessStatus.DENIED);
    ...
    public void testRecordCategoryAsRecordsManager()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            {
                AuthenticationUtil.setFullyAuthenticatedUser(rm_records_manager);
                permissionService.setPermission(recordCategory_1, rm_records_manager, FILING, true);
                Map<Capability, AccessStatus> access = recordsManagementSecurityService.getCapabilities(recordCategory_1);
                assertEquals(65, access.size()); // 58 + File
                check(access, ACCESS_AUDIT, AccessStatus.ALLOWED);
                check(access, ADD_MODIFY_EVENT_DATES, AccessStatus.DENIED);
    ...
    public void testRecordCategoryAsSecurityOfficer()
    {
        retryingTransactionHelper.doInTransaction(new RetryingTransactionCallback<Object>()
        {
            ...
            {
                AuthenticationUtil.setFullyAuthenticatedUser(rm_security_officer);
                permissionService.setPermission(recordCategory_1, rm_security_officer, FILING, true);
                Map<Capability, AccessStatus> access = recordsManagementSecurityService.getCapabilities(recordCategory_1);
                assertEquals(65, access.size()); // 58 + File
                check(access, ACCESS_AUDIT, AccessStatus.DENIED);
                check(access, ADD_MODIFY_EVENT_DATES, AccessStatus.DENIED);
    ...
    private void setFilingOnRecord(NodeRef record, String authority)
    {
        ...
        permissionService.setPermission(nodeService.getPrimaryParent(recordFolder).getParentRef(), authority, READ_RECORDS, true);
    }
