...
public class ViewUpdateReasonsForFreezeCapability extends AbstractCapability
{

    public ViewUpdateReasonsForFreezeCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.VIEW_UPDATE_REASONS_FOR_FREEZE;
    }
}