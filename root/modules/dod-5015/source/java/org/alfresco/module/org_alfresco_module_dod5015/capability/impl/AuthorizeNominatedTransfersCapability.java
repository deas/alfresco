...
public class AuthorizeNominatedTransfersCapability extends AbstractCapability
{

    public AuthorizeNominatedTransfersCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.AUTHORIZE_NOMINATED_TRANSFERS;
    }
}