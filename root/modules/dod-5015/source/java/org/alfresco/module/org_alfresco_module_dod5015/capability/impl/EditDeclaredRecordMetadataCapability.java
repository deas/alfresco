...
public class EditDeclaredRecordMetadataCapability extends AbstractCapability
{

    public EditDeclaredRecordMetadataCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.EDIT_DECLARED_RECORD_METADATA;
    }
}