...
import org.alfresco.module.org_alfresco_module_dod5015.identifier.IdentifierService;
                                            ...
                                            NodeServicePolicies.OnCreateNodePolicy
{
    ...
    public void init()
    {
        ...
        this.policyComponent.bindClassBehaviour(
                ...
                TYPE_RECORDS_MANAGEMENT_ROOT_CONTAINER, 
    ...
    {   
        ...
        {       
            ...
            if (nodeService.hasAspect(child, ASPECT_FILE_PLAN_COMPONENT) == false)
            {
                ...
                // TODO We need a rm container factory in here to figure out what sub-type of folder we should be creating ... 
        ...
        // else 
        //    non-folder types created in containers will be delt with by the normal "auto-file"
        //    behaviour (ie: documents will be filed and turned into records)
    }
