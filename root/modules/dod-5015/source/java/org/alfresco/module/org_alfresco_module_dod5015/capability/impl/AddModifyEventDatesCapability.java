...
public class AddModifyEventDatesCapability extends AbstractCapability
{

    public AddModifyEventDatesCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.ADD_MODIFY_EVENT_DATES;
    }
}