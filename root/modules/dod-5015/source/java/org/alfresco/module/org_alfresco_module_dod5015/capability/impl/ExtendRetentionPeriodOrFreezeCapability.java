...
public class ExtendRetentionPeriodOrFreezeCapability extends AbstractCapability
{

    public ExtendRetentionPeriodOrFreezeCapability()
    {
        super();
    }
    ...
    {
        return RMPermissionModel.EXTEND_RETENTION_PERIOD_OR_FREEZE;
    }
}