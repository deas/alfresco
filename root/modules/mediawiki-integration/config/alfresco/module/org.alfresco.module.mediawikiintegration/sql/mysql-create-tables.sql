...
CREATE TABLE /*$wgDBprefix*/filearchive (
  ...
  PRIMARY KEY (fa_id), 							-- pick out by image name
  INDEX (fa_name, fa_timestamp),  				-- pick out dupe files           
  INDEX (fa_storage_group, fa_storage_key),  	-- sort by deletion time
  INDEX (fa_deleted_timestamp),    				-- sort by deleter          
  INDEX (fa_deleted_user)                    
